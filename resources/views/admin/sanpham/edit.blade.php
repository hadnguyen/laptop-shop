        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $sanpham->cpu }}" class="form-control" name="cpu" id="cpu" aria-describedby="helpId"
                                placeholder="CPU">
                            @error('cpu')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $sanpham->ram }}" class="form-control" name="ram" id="ram" aria-describedby="helpId"
                                placeholder="Ram">
                            @error('ram')
                                <small class="text-help text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $sanpham->ocung }}" class="form-control" name="ocung" id="ocung" aria-describedby="helpId"
                                placeholder="Ổ cứng">
                            @error('ocung')
                                <small class="text-help text-danger">{{ $message }}</small>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $sanpham->carddohoa }}" class="form-control" name="carddohoa" id="carddohoa" aria-describedby="helpId"
                                placeholder="VGA">
                            @error('carddohoa')
                                <small class="text-help text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $sanpham->manhinh }}" class="form-control" name="manhinh" id="manhinh" aria-describedby="helpId"
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $sanpham->hangsanxuat }}" class="form-control" name="hangsanxuat" id="hangsanxuat" aria-describedby="helpId"
