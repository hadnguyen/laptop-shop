    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__widget">
            ...
            <div class="header__top__right__auth">
                @if (Auth::check())
                    <div class="header__top__right__language">
                        <div>Tài khoản: {{ Auth::user()->name }}</div>
                        <span class="arrow_carrot-down"></span>
                        <ul>
                            <li><a href="{{ route('admin.getlogout') }}" class="dropdown-item">
                                    <i class="fa fa-sign-out" aria-hidden="true"></i> Đăng xuất</a></li>
                        </ul>
                    </div>
                @else
                    <a href="{{ route('admin.getlogin') }}"><i class="fa fa-user"></i> Đăng
                        nhập</a>
                    <a href="{{ route('register') }}"><i class="register"></i> Đăng kí</a>
                @endif
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-map-marker"></i>TÌM CỬA HÀNG GẦN NHẤT</li>
                                <li><i class="fa fa-shield"></i>Tra cứu bảo hành</li>
                                <li><i class="fa fa-headphones"></i>Góp ý, khiếu nại</li>
                                <li><i class="fa fa-bullhorn"></i>Tuyển dụng</li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="footer__widget">
                        <h6>KÊNH THÔNG TIN</h6>
                        <p>Mời bạn nhập email để nhận những thông tin khuyến mại mới nhất từ LaptopH</p>
                        <form action="#">
